...
# python ssd_object_detection.py --use-gpu 1
...
ap.add_argument("-i", "--input", type=str, default="../example_videos/d.mp4",
	help="path to (optional) input video file")
ap.add_argument("-o", "--output", type=str, default="../output_videos/zzz.avi",
